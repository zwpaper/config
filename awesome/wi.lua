...
vicious.register(rootfsused, vicious.widgets.fs,
  "<span color='" .. beautiful.fg_em .. "'>DISK/ </span>${/ used_gb}GB", 97)
...
vicious.register(txwidget, vicious.widgets.net, "TX ${eth0 up_kb}", 2)
...
vicious.register(rxwidget, vicious.widgets.net, "RX ${eth0 down_kb}", 2)
-- }}}
