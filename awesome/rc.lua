...
-- {{{ Tags
tags = { name={"1 :Daily", "2 :Internet", "3 :Shell", "4 :Coding", "Q :Media", "W :Others", "E :Virtual", "R :Back"},
        layout={layouts[2], layouts[6], layouts[2], layouts[6], layouts[6], layouts[5], layouts[6], layouts[1]},
        screenkey={ "1", "2", "3", "4","q", "w", "e", "r"}}
for s = 1, screen.count() do
...
for i = 1, 8 do
  globalkeys = awful.util.table.join(globalkeys,
    awful.key({ modkey }, tags.screenkey[i],
      function()
        local screen = mouse.screen
